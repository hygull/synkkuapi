//https://github.com/goware/jwtauth/blob/master/_example/main.go
...
func init() {
	...
	fmt.Printf("%T", tokenString) //string
...
func router() http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		fmt.Println("About to call authenticator")
		r.Use(jwtauth.Authenticator)

		r.Get("/admin", func(w http.ResponseWriter, r *http.Request) {
			fmt.Println("Getting....")
			ctx := r.Context()
			fmt.Println("ctx created....")
